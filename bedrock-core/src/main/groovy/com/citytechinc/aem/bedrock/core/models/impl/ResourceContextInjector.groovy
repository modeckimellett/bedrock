...
/**
 * Injector for objects derived from the current resource context.
 */
@Component
@Service(Injector)
@Property(name = Constants.SERVICE_RANKING, intValue = Integer.MAX_VALUE)
@Slf4j("LOG")
class ResourceContextInjector extends AbstractBedrockInjector {
    ...
    Object inject(Object adaptable, String name, Type type, AnnotatedElement element,
        ...
        if (type instanceof Class) {
            ...
            if (resource) {
                value = getValueForClass(type as Class, resource)
            }
        }
    ...
    private static def getValueForClass(Class clazz, Resource resource) {
        def value = null
