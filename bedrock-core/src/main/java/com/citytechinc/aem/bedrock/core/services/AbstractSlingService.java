...
/**
 * Base class for services that require an administrative <code>Session</code>
 * and/or <code>ResourceResolver</code>.
 */
...
public abstract class AbstractSlingService {
	...
	/**
	 * Activate this service. Extending classes should call
	 * <code>getAdministrativeResourceResolver()</code> and/or
	...
	/**
	 * Deactivate this service. Extending classes should call
	 * <code>closeResourceResolver()</code> and <code>closeSession()</code> in
	 * this method.
	 */
	protected abstract void deactivate(final ComponentContext componentContext, final Map<String, Object> properties);

	/**
	 * Close the administrative resource resolver. This method should be called
	 * by the <code>@Deactivate</code> method of the implementing class if the
	 * <code>getAdministrativeResourceResolver()</code> method was used at any
	 * time.
	 */
