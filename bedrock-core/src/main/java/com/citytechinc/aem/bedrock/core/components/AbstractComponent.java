 ...
 * {@link com.citytechinc.aem.bedrock.core.tags.ComponentTag} or implemented
 * with Sightly.
 */
...
public abstract class AbstractComponent implements Component {
	...
	/**
	 * The current request. May be null if component was instantiated from a
	 * servlet.
	 */
	private ComponentRequest componentRequest;

	/**
	 * Initialize this component. This default implementation does nothing;
	 ...
	 * @return component instance or absent <code>Optional</code> if path does
	 *         not resolve to a resource
	 */
	@Override
	 ...
	 *
	 * @param componentNode component node representing resource of desired
	 *            component
	 * @param type component class type
	...
	public final Optional<Link>
		getAsLinkInherited(final String propertyName, final boolean strict, final boolean mapped) {
	...
	@Override
	public final <AdapterType> Optional<AdapterType>
		getAsType(final String propertyName, final Class<AdapterType> type) {
	...
	/**
	 * Get the path of the current component with a ".html" extension. This
	 * method can be overridden to return an implementation-specific value.
	 *
	...
	/**
	 * Get a link object to the path for the current component. This method can
	 * be overridden to modify the default behavior and return a different
	 * <code>Link</code> instance or implementation.
	 *
	...
	private <T extends Component> Optional<T> getComponentForResource(final Resource resource, final Class<T> type) {
		...
		if (resource != null) {
			...
			if (type.isAnnotationPresent(Model.class)
				...
				// Otherwise fineness the existing bindings to be appropriate to
				// the
