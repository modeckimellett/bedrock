...
/**
 * Extendable class that delegates to a <code>ComponentNode</code> instance. Use
 * when instantiating component node instances directly (i.e. not in the context
 * of a JSP or Sightly request).
 */
...
public abstract class DelegateComponentNode implements ComponentNode {
	...
	@Override
	public BasicNode getNodeInherited(final String relativePath) {
