...
/**
 * Base class for CQ component classes instantiated by the {@link com.citytechinc.aem.bedrock.tags.ComponentTag}.
 */
...
public abstract class AbstractComponent implements ComponentNode {
     ...
     * class that extends this class (which itself was instantiated by the {@link com.citytechinc.aem.bedrock.tags.ComponentTag}).
     *
