 ...
 * @class CQ.Ext.form.SuperBoxSelect
 ...
 *
 */
CQ.Ext.form.SuperBoxSelect = function(config) {
    CQ.Ext.form.SuperBoxSelect.superclass.constructor.call(this,config);
    this.addEvents(
        /**
         ...
         * @event beforeadditem
         * @memberOf CQ.Ext.form.SuperBoxSelect
    ...
    this.addListener('beforeadditem', function(self, recordValue) {
        var start = 0;
        var end = 0;
        ...
        if (window.event.shiftKey) {
            ...
            if(this.firstChoiceIndex == undefined) {
                ...
                CQ.Ext.each(selectedRecords, function(item, index, allitems) {
                    self.addRecord(item)
                });
...
CQ.Ext.form.SuperBoxSelect = CQ.Ext.extend(CQ.Ext.form.SuperBoxSelect,CQ.Ext.form.ComboBox,{
    ...
    /**
     * @cfg {String/Object/Function} extraItemStyle Additional css style(s) to apply to each item. Should be a valid argument to CQ.Ext.Element.applyStyles.
     */
    extraItemStyle: '',
     ...
     */
    itemDelimiterKey: CQ.Ext.EventObject.ENTER,
    /**
    ...
    initComponent:function() {
       CQ.Ext.apply(this, {
            items           : new CQ.Ext.util.MixedCollection(false),
            usedRecords     : new CQ.Ext.util.MixedCollection(false),
            addedRecords    : [],
            remoteLookup    : [],
            hideTrigger     : true,
            grow            : false,
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.initComponent.call(this);
    ...
    onRender:function(ct, position) {
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.onRender.call(this, ct, position);
        this.hiddenName = h;
    ...
    onStoreLoad : function(store, records, options){
        ...
        if(q !== '' && this.allowAddNewData){
            CQ.Ext.each(this.remoteLookup,function(r){
        ...
        var toAdd = [];
        if(q === ''){
            CQ.Ext.each(this.addedRecords,function(rec){
            ...
            var re = new RegExp(CQ.Ext.escapeRe(q) + '.*','i');
            CQ.Ext.each(this.addedRecords,function(rec){
                if(this.preventDuplicates && this.usedRecords.containsKey(rec.get(this.valueField))){
                    return;
                }
        ...
        //Ramana
        //Commented this as sort control can be with the caller instead of restricting with the displayfield
    ...
    doTransform : function() {
        var s = CQ.Ext.getDom(this.transform), transformValues = [];
            if(!this.store){
                this.mode = 'local';
                var d = [], opts = s.options;
                for(var i = 0, len = opts.length;i < len; i++){
                    var o = opts[i], oe = CQ.Ext.get(o),
                ...
                this.store = new CQ.Ext.data.SimpleStore({
                    'id': 0,
    ...
    initEvents : function() {
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.initEvents.call(this);

        CQ.Ext.apply(this.keyNav, {
            tab: function(e) {
    ...
    beforeBlur: CQ.Ext.form.ComboBox.superclass.beforeBlur,

    onFocus: function() {
        this.outerWrapEl.addClass(this.focusClass);

        CQ.Ext.form.SuperBoxSelect.superclass.onFocus.call(this);
    },
    ...
    onBlur: function() {
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.onBlur.call(this);
    },
    ...
    markInvalid : function(msg) {
        ...
        switch (this.msgTarget) {
            case 'qtip':
                CQ.Ext.apply(this.el.dom, {
                    qtip    : msg,
                    qclass  : 'x-form-invalid-tip'
                });
                CQ.Ext.apply(this.wrapEl.dom, {
                    qtip    : msg,
                    qclass  : 'x-form-invalid-tip'
                });
            ...
            case 'side':
                ...
                this.alignErrorIcon();
                CQ.Ext.apply(this.errorIcon.dom, {
                    qtip    : msg,
                    qclass  : 'x-form-invalid-tip'
                });
                this.errorIcon.show();
                ...
                break;
            default:
                t = CQ.Ext.getDom(this.msgTarget);
                t.innerHTML = msg;
    ...
    alignErrorIcon : function(){
        if(this.wrap){
            this.errorIcon.alignTo(this.wrap, 'tl-tr', [CQ.Ext.isIE ? 5 : 2, 3]);
        }
    },
    expand : function(){
    ...
    restrictHeight : function(){
        ...
        var pad = list.getFrameWidth('tb')+(this.resizable?this.handleHeight:0)+this.assetHeight,
            ...
            ha = this.getPosition()[1]-CQ.Ext.getBody().getScroll().top,
            hb = CQ.Ext.lib.Dom.getViewHeight()-ha-this.getSize().height,
    ...
    setupFormInterception : function(){
        ...
        if(form){
            ...
            form.getValues = function(asString){
                ...
                return asString ? CQ.Ext.urlEncode(vals) : vals ;
            }.createDelegate(this);
        }
    },
    onResize : function(w, h, rw, rh) {
        var reduce = CQ.Ext.isIE6 ? 4 : CQ.Ext.isIE7 ? 1 : CQ.Ext.isIE8 ? 1 : 0;
        if(this.wrapEl){
            this._width = w;
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.onResize.call(this, w, h, rw, rh);
        this.autoSize();
    },
    onEnable: function(){
        CQ.Ext.form.SuperBoxSelect.superclass.onEnable.call(this);
    ...
    onDisable: function(){
        CQ.Ext.form.SuperBoxSelect.superclass.onDisable.call(this);
        this.items.each(function(item){
            item.disable();
        });
        if(this.renderFieldBtns){
    ...
    clearValue : function(supressRemoveEvent){
        CQ.Ext.form.SuperBoxSelect.superclass.clearValue.call(this);
    ...
    reset :  function(){
        this.killItems();
        CQ.Ext.form.SuperBoxSelect.superclass.reset.call(this);
        this.addedRecords = [];
    ...
    getCaption: function(dataObject){
        if(typeof this.displayFieldTpl === 'string') {
            this.displayFieldTpl = new CQ.Ext.XTemplate(this.displayFieldTpl);
        }
        var caption, recordData = dataObject instanceof CQ.Ext.data.Record ? dataObject.data : dataObject;
    ...
    createRecord : function(recordData){
        if(!this.recordConstructor){
            ...
            this.recordConstructor = CQ.Ext.data.Record.create(recordFields);
        }
        return new this.recordConstructor(recordData);
    },
    /**
     * Adds an array of items to the SuperBoxSelect component if the {@link #CQ.Ext.form.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name addItem
     * @param {Array} newItemObjects An Array of object literals containing the property names and values for an item. The property names must match those specified in {@link #CQ.Ext.form.SuperBoxSelect-displayField}, {@link #CQ.Ext.form.SuperBoxSelect-valueField} and {@link #CQ.Ext.form.SuperBoxSelect-classField}
     */
    addItems : function(newItemObjects){
        if (CQ.Ext.isArray(newItemObjects)) {
            CQ.Ext.each(newItemObjects, function(item) {
                this.addItem(item);
            }, this);
        } else {
    ...
    /**
     * Adds a new non-existing item to the SuperBoxSelect component if the {@link #CQ.Ext.form.SuperBoxSelect-allowAddNewData} config is set to true.
     * This method should be used in place of addItem from within the newitem event handler.
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name addNewItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #CQ.Ext.form.SuperBoxSelect-displayField}, {@link #CQ.Ext.form.SuperBoxSelect-valueField} and {@link #CQ.Ext.form.SuperBoxSelect-classField}
     */
    addNewItem : function(newItemObject){
        this.addItem(newItemObject,true);
    },
    /**
     * Adds an item to the SuperBoxSelect component if the {@link #CQ.Ext.form.SuperBoxSelect-allowAddNewData} config is set to true.
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name addItem
     * @param {Object} newItemObject An object literal containing the property names and values for an item. The property names must match those specified in {@link #CQ.Ext.form.SuperBoxSelect-displayField}, {@link #CQ.Ext.form.SuperBoxSelect-valueField} and {@link #CQ.Ext.form.SuperBoxSelect-classField}
     */
    ...
    addItemBox : function(itemVal,itemDisplay,itemCaption, itemClass, itemStyle) {
        var hConfig, parseStyle = function(s){
            ...
            return ret;
        }, itemKey = CQ.Ext.id(null,'sbx-item'), box = new CQ.Ext.form.SuperBoxSelectItem({
            owner: this,
    ...
    /**
     * Returns a String value containing a concatenated list of item values. The list is concatenated with the {@link #CQ.Ext.form.SuperBoxSelect-valueDelimiter}.
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name getValue
    ...
    /**
     * Returns an Array of item objects containing the {@link #CQ.Ext.form.SuperBoxSelect-displayField}, {@link #CQ.Ext.form.SuperBoxSelect-valueField}, {@link #CQ.Ext.form.SuperBoxSelect-classField} and {@link #CQ.Ext.form.SuperBoxSelect-styleField} properties.
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name getValueEx
    ...
    initValue : function(){
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.initValue.call(this);
        if(this.mode === 'remote') {
     ...
     * @methodOf CQ.Ext.form.SuperBoxSelect
     * @name setValue
     * @param {String|Array} value An array of item values, or a String value containing a delimited list of item values. (The list should be delimited with the {@link #CQ.Ext.form.SuperBoxSelect-valueDelimiter)
     */
    setValue : function(value){
        ...
        CQ.Ext.each(values,function(val){
            var record = this.findRecord(this.valueField, val);
            if(record){
                this.addRecord(record);
    ...
    setValueEx : function(data){
        ...
        CQ.Ext.each(data,function(item){
            this.addItem(item);
        },this);
    },
    /**
    ...
    onDestroy : function() {
        ...
        CQ.Ext.form.SuperBoxSelect.superclass.onDestroy.call(this);
    },
    ...
    autoSize : function(){
        ...
        if(!this.metrics){
            this.metrics = CQ.Ext.util.TextMetrics.createInstance(this.el);
        }
        var el = this.el,
            v = el.dom.value,
    ...
    doQuery : function(q, forceAll,valuesQuery, forcedAdd){
        ...
        if(forceAll === true || (q.length >= this.minChars) || valuesQuery && !CQ.Ext.isEmpty(q)){
...
CQ.Ext.reg('superboxselect', CQ.Ext.form.SuperBoxSelect);
/*
 * @private
 */
CQ.Ext.form.SuperBoxSelectItem = function(config){
    CQ.Ext.apply(this,config);
    CQ.Ext.form.SuperBoxSelectItem.superclass.constructor.call(this);
};
/*
 * @private
 */
CQ.Ext.form.SuperBoxSelectItem = CQ.Ext.extend(CQ.Ext.form.SuperBoxSelectItem,CQ.Ext.Component, {
    initComponent : function(){
        CQ.Ext.form.SuperBoxSelectItem.superclass.initComponent.call(this);
    },
    ...
    onRender : function(ct, position){
        ...
        CQ.Ext.form.SuperBoxSelectItem.superclass.onRender.call(this, ct, position);
        ...
        var btnEl = this.owner.navigateItemsWithTab ? ( CQ.Ext.isSafari ? 'button' : 'a') : 'span';
    ...
    setupKeyMap : function(){
        this.keyMap = new CQ.Ext.KeyMap(this.lnk, [
            {
                key: [
                    CQ.Ext.EventObject.BACKSPACE,
                    CQ.Ext.EventObject.DELETE,
                    CQ.Ext.EventObject.SPACE
                ],
                fn: this.preDestroy,
                scope: this
            }, {
                key: [
                    CQ.Ext.EventObject.RIGHT,
                    CQ.Ext.EventObject.DOWN
                ],
                fn: function(){
            ...
            {
                key: [CQ.Ext.EventObject.LEFT,CQ.Ext.EventObject.UP],
                fn: function(){
                    this.moveFocus('left');
                },
                scope: this
    ...
    onDisable : function() {
        ...
        this.keyMap.disable();
        CQ.Ext.form.SuperBoxSelectItem.superclass.onDisable.call(this);
    },
    onEnable : function() {
        if(this.hidden){
        ...
        this.keyMap.enable();
        CQ.Ext.form.SuperBoxSelectItem.superclass.onEnable.call(this);
    },
    onDestroy : function() {
        CQ.Ext.destroy(
            this.lnk,
        ...
        CQ.Ext.form.SuperBoxSelectItem.superclass.onDestroy.call(this);
    }
});